...
val amplitudeRunnable = object : Runnable {
    override fun run() {
        if (mediaRecorder != null) {
            ...
            if (dblast - db > 20 || currentTime - lastMaxAmplitudeTime >= 10000/*maxAmplitude < lastMaxAmplitude*/ /*&& currentTime - lastMaxAmplitudeTime < 2000*/) {
                stopRecording()
            } /*else if (currentTime - lastMaxAmplitudeTime >= 10000) {
                stopRecording()
            }*/ else {
                //lastMaxAmplitudeTime = currentTime
